	...
	<body>
		<div class="bgintor">				
			<div class="listintor">
				<div class="tit1">
					<ul>				
						<li><a href="#">AdManage</a></li>
					</ul>		
				</div>
				<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
					<span>Position:AdManage －&gt; <strong>Add Ads</strong></span>
...
/admin_manage/system_manage/system_modify.php" method="post" id="doForm">
				<p>Ad name:<input class="in1" type="text" name="web_name" id="name" value="<?php echo $_smarty_tpl->tpl_vars['array']->value['web_name'];?>
" /></p>			
				<p>Page URL：
...
" width="50px" height="60px" alt="PageLOGO"/>
				...
				<br>
				<p>Hot keyWords:<input class="in1" type="text" name="hot_word" id="name" value="<?php echo $_smarty_tpl->tpl_vars['array']->value['hot_word'];?>
" /></p>(Muti KeyWords divided by ',')
				<p>Page Describe:<input class="in1" type="text" name="description" id="name" value="<?php echo $_smarty_tpl->tpl_vars['array']->value['description'];?>
" /></p>
				<p>Administrator Tel:<input class="in1" type="text" name="phone" id="name" value="<?php echo $_smarty_tpl->tpl_vars['array']->value['phone'];?>
" /></p>
				<p>Email:<input class="in1" type="text" name="email" id="name" value="<?php echo $_smarty_tpl->tpl_vars['array']->value['email'];?>
" /></p>
				<p>Cache existing time:<input class="in1" type="text" name="lifetime" value="<?php echo $_smarty_tpl->tpl_vars['array']->value['lifetime'];?>
" /></p>
				<p>Setting copyright:<input class="in1" type="text" name="copyright" id="name" value="<?php echo $_smarty_tpl->tpl_vars['array']->value['copyright'];?>
" /></p>
